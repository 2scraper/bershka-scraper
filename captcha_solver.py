...
page. If Bershka renders a reCAPTCHA/Turnstile challenge anywhere —
...
def detect_aws_waf(html: str, page_url: str = "") -> Optional[CaptchaChallenge]:
    ...
    Measured on a SIBLING repo's site (www.transfermarkt.com) 2026-09-16:
...
# form is one example) was ever observed on Bershka, and porting one
